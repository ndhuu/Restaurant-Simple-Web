...
router.get('/edit/fnb:rname&:address', function (req, res, next) {
  ...
  pool.query(sql_query.query.view_fnb, [rname, address], (err, data) => {
    if (err) {
      ...
      res.render('my_restaurants_edit/fnb', { title: 'My Restaurant', data: data.rows});
    }
  });
});
...
router.post('/edit/avail/add', function (req, res, next) {
  ...
  pool.query(sql_query.query.add_oh, [rname, address, day, s_time, hours], (err, data) => {
    ...
    res.redirect(`/my_restaurants/edit/avail:${rname}&:${address}`)    
  });
});
...
router.get('/edit/ophr:rname&:address', function (req, res, next) {
  ...
  pool.query(sql_query.query.view_fnb, [rname, address], (err, data) => {
    if (err) {
      ...
      res.render('my_restaurants_edit/ophr', { title: 'My Restaurant', data: data.rows});
    }
  });
});
...
router.get('/edit/prom:rname&:address', function (req, res, next) {
  ...
  pool.query(sql_query.query.view_fnb, [rname, address], (err, data) => {
    if (err) {
      ...
      res.render('my_restaurants_edit/prom', { title: 'My Restaurant', data: data.rows});
    }
  });
});
...
router.get('/edit/owners:rname&:address', function (req, res, next) {
  ...
  pool.query(sql_query.query.view_fnb, [rname, address], (err, data) => {
    if (err) {
      ...
      res.render('my_restaurants_edit/owners', { title: 'My Restaurant', data: data.rows});
    }
  });
});
...
router.post('/edit/prom/add', function (req, res, next) {
  ...
  pool.query(sql_query.query.add_oh, [rname, address, time, discount], (err, data) => {
    ...
    res.redirect(`/my_restaurants/edit/owners:${rname}&:${address}`)    
  });
});
...
router.get('/edit/workers:rname&:address', function (req, res, next) {
  ...
  pool.query(sql_query.query.view_fnb, [rname, address], (err, data) => {
    if (err) {
      ...
      res.render('my_restaurants_edit/workers', { title: 'My Restaurant', data: data.rows});
    }
  });
});

router.post('/edit/workers/add', function (req, res, next) {
  var rname = req.body.rname
  var address = req.body.address
  var time = req.body.time
  var discount = req.body.discount
  ...
  pool.query(sql_query.query.add_oh, [rname, address, time, discount], (err, data) => {
    ...
    res.redirect(`/my_restaurants/edit/workers:${rname}&:${address}`)    
  });
});


router.post('/edit/workers/delete', function (req, res, next) {
  var rname = req.body.rname
  var address = req.body.address
  var time = req.body.time
  var discount = req.body.discount
